...
## API Documentation
 ...
 For detailed API documentation, including authentication, scopes, and examples for both REST and GraphQL, please refer to [API_DOCUMENTATION.md](API_DOCUMENTATION.md).
