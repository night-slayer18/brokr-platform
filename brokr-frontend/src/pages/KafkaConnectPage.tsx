...
import type { DeleteKafkaConnectMutation, DeleteKafkaConnectMutationVariables, GetKafkaConnectsQuery, TestKafkaConnectConnectionMutation, TestKafkaConnectConnectionMutationVariables } from '@/graphql/types';
import { Card, CardContent, CardDescription, CardHeader, CardTitle } from '@/components/ui/card';
import { Button } from '@/components/ui/button';
import { Badge } from '@/components/ui/badge';
import { Skeleton } from '@/components/ui/skeleton';
import { Plus, Trash2, Eye, RefreshCw, PlugZap } from 'lucide-react';
...
export default function KafkaConnectPage() {
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      toast.error(err.message || 'Failed to delete Kafka Connect instance');
    } finally {
  ...
  const handleTestConnection = async (id: string, name: string) => {
    try {
      ...
      if (data?.testKafkaConnectConnection) {
